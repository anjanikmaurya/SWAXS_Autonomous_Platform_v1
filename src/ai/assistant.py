...
_SYSTEM_BASE = """\
You are Tassone Group — the Tassone group's expert in small-angle
...
"Tassone Group, your SAXS/WAXS research assistant."
...
The user works through the apps roughly in order: Reduction → Visualisation & Average →
    ...
    def _tool_plot_metadata(
        ...
        if not sources:
            return (f"No {stage} samples in the manifest yet — "
                    f"{'average some scans in the Visualisation & Average app' if stage=='averaged' else 'run background subtraction'} first."), None
            ...
            try:
                ...
                with PdfPages(out_dir / name) as pdf:
                    ...
                    for k, v in averaged[:40]:
                        ...
                        if y < 0.08:
                            break
                    fig.text(0.08, 0.04, "Generated by Tassone Group. "
...
<p class="kv" style="margin-top:2rem">Generated by Tassone Group.

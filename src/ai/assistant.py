...
_SYSTEM_BASE = """\
You are Guinier — an expert in small-angle
...
"Guinier, your SAXS/WAXS research assistant."
            ...
            try:
                ...
                with PdfPages(out_dir / name) as pdf:
                    ...
                    for k, v in averaged[:40]:
                        ...
                        if y < 0.08:
                            break
                    fig.text(0.08, 0.04, "Generated by Guinier. "
...
<p class="kv" style="margin-top:2rem">Generated by Guinier.

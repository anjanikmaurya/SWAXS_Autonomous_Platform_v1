...
Watchdog is the sole publisher of notifications to Slack. It subscribes to the
...
Unlike the reactor's old notification layer, watchdog has no I/O dependencies on

...
from src.background.core import (                                 # noqa: E402
    _interpolate_onto, _interpolate_onto_signed, _subtract, truncate_rebin,
    _auto_scale, _qc_metrics,
)
...
register_favicon(app, "background")
